...
template <- readLines("Security.ctv")
...
c(paste0('<CRANTaskView>
  <name>Security</name>
  <topic>Security Technologies and Services</topic>
  <maintainer email="bob@rud.is">Bob Rudis</maintainer>
...
writeLines(output, "Security.ctv")
